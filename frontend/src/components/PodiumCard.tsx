...
const podiumStyle = {
  1: {
    // Kept the massive Imperial Gold glow, but swapped the bottom reflection to Montreal Frost Blue
    glow: "shadow-[0_0_50px_rgba(255,215,0,0.15)] z-10",
    border: "border-t-4 border-t-[#FFD700] border-x-white/5 border-b-2 border-b-[#00D2FF]/50",
