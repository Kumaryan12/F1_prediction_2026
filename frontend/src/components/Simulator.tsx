      ...
      <div className="grid gap-8 md:grid-cols-2 relative z-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <select 
              className="w-full rounded border border-white/20 bg-black/60 px-4 py-3 text-lg font-bold italic uppercase text-white outline-none focus:border-spielberg-red transition-colors"
          ...
          <div>
            ...
            <input 
              ...
              className="w-full h-2 bg-black rounded-lg appearance-none cursor-pointer accent-styrian-green"
            />
